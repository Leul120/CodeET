...
const ContactUs = () => {
  ...
  return (
    <div className='flex flex-row'>
      <section className='logo w-1/2 min-h-screen flex items-center bg-slate-900 h-full text-white'>
        <div className='text-7xl font-bold bg-gradient-to-r from-indigo-400 to-blue-800 text-transparent bg-clip-text -rotate-90 h-full w-full pl-24'>CodeET</div>
      </section>
      <div className='flex justify-center pt-16 w-full bg-slate-800 min-h-screen h-full'>
        <div className='p-10 rounded-xl bg-slate-700 text-white'>
          <h1 className='font-bold text-sky-500 pb-20'>Contact Us</h1>
          <form onSubmit={handleSubmit(submitData)}>
            <div className='flex flex-row gap-3 pb-5'>
              <Controller
                ...
                rules={{ required: true }}
                render={({ field }) => (
                  <input className='w-full border-gray-400 bg-gray-900 border-b-2 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-purple-400' placeholder='First Name' {...field} />
                )}
              />
              <Controller
                name='lastName'
                ...
                rules={{ required: true }}
                render={({ field }) => (
                  <input className='w-full border-gray-400 bg-gray-900 border-b-2 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-purple-400' placeholder='Last Name' {...field} />
                )}
              />
            </div>
            <Controller
              ...
              rules={{ required: true }}
              render={({ field }) => (
                <input className='w-full border-gray-400 bg-gray-900 mb-5 border-b-2 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-purple-400' placeholder='Email' {...field} />
              )}
            />
            <Controller
              name='phoneNumber'
              ...
              rules={{ required: true }}
              render={({ field }) => (
                <input className='w-full border-gray-400 bg-gray-900 mb-5 border-b-2 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-purple-400' placeholder='Phone Number' {...field} />
              )}
            />
            <Controller
              name='description'
              ...
              rules={{ required: true }}
              render={({ field }) => (
                <textarea className='w-full border-gray-400 bg-gray-900 border-2 rounded-lg px-3 py-2 h-44 text-white focus:outline-none focus:border-purple-400' placeholder='Description' {...field} />
              )}
            />
            {loading ? (
              <button type='submit' disabled className="w-full h-9 mt-3 rounded-3xl p-1 text-white flex gap-2 items-center justify-center bg-purple-500 text-sm">
                <LoadingOutlined spinning allowFullScreen size="large" style={{ color: "white" }} /> Send
              </button>
            ) : (
