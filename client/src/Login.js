    ...
    <div className='pt-20 bg-stone-100 h-screen'>
      <form onSubmit={handleSubmit(submitData)} className='max-w-sm mx-auto mt-10 bg-white p-10 rounded-3xl shadow-lg'>
        ...
        <div className='flex justify-between items-center border border-border bg-white rounded-3xl mt-1'>
          <input 
            type={passwordType} 
            className='border-white text-black pl-2 h-10 w-full focus:outline-none rounded-3xl' 
        ...
        {loading ? (
          <button type='submit' disabled className="w-full h-9 mt-3 rounded-3xl p-1 text-white flex gap-2 text-sm items-center justify-center bg-purple-700">
