  ...
  return (
    <div className="min-h-screen bg-gray-900  text-white flex flex-col items-center pt-32 py-10">
      {!error && (
        ...
        <Alert message="Please Refresh the page once again if you've bought this course and the Enroll button is not changed to Go to course button!" type="info" closable showIcon className={`m-2 absolute top-16`}   />
          {isLoading ? (
