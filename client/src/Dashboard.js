...
useEffect(() => {
  ...
  return (
    <div >
        {storedUser?isLoading? (<div className='w-full  mt-64 flex items-center justify-center text-3xl'><LoadingOutlined spinning allowFullScreen size="large" style={{color:"black",font:50}}/></div>):(<div className='pt-24 bg-slate-300 h-screen' ><h1 className='text-white'> </h1>
